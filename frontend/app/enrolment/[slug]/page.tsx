      ...
      <section className="relative isolate px-5 py-12 sm:px-8 lg:px-12">
        ...
        <div className="relative mx-auto grid w-full max-w-6xl gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <article className="overflow-hidden rounded-[1.8rem] border border-slate-200/80 bg-white/88 shadow-[0_24px_64px_rgba(15,23,42,0.08)] backdrop-blur-md">
            <div className="relative aspect-[3/4] min-h-[34rem] bg-[#f7f1e8] sm:min-h-[42rem]">
              <Image
                src={course.image}
                alt={course.imageAlt}
                fill
          ...
          <article className="space-y-6 rounded-[1.8rem] border border-slate-200/80 bg-white/88 p-6 shadow-[0_24px_64px_rgba(15,23,42,0.08)] backdrop-blur-md sm:p-8">
            <div>
          ...
          <aside
            id="square-payments"
            className="rounded-[1.8rem] border border-slate-200/80 bg-white/92 p-6 shadow-[0_24px_64px_rgba(15,23,42,0.08)] backdrop-blur-md sm:p-8 lg:col-span-2"
          >
            <p className="text-[0.72rem] font-semibold uppercase tracking-[0.24em] text-amber-800/80">
