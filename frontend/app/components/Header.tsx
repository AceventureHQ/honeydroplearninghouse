...
function HeaderContent({ pathname }: { pathname: string }) {
  ...
  return (
    ...
    >
      <nav
        aria-label="Primary"
        className={`mx-auto flex w-full max-w-6xl flex-col px-3 py-3 shadow-none backdrop-blur-0 sm:px-5 ${
          isHomePage
      ...
      >
        <div className="flex items-center justify-start md:justify-center">
          <button
            ...
            className="inline-flex items-center justify-center rounded-full border border-white/30 bg-white/10 p-2 text-current transition-colors hover:bg-white/20 md:hidden"
        ...
        <div className="hidden flex-wrap items-center justify-center gap-x-4 gap-y-2 md:flex md:gap-x-5">
