            ...
            <div className="flex flex-col gap-6">
              <div className="rounded-[2rem] border border-slate-200/80 bg-white/90 p-6 shadow-[0_24px_64px_rgba(15,23,42,0.08)] backdrop-blur-md sm:p-8 lg:p-10">
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-700 sm:text-lg">
                  Whether you want to ask about programs, schedule an intake
                  conversation, or talk through payment options, we can point
                ...
                <div className="mt-8 grid gap-4 sm:grid-cols-2">
                  {[
                    ...
                    [
                      "Location",
                      "303 Front Street Belleville, Ontario K8N 2Z9",
                    ],
                  ].map(([label, value]) => (
                    <div
                      key={label}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-7 text-slate-700">
                      We reply best when families share the learner&apos;s age,
                      main goal, and preferred schedule.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
              ...
              <div className="overflow-hidden rounded-[1.8rem] border border-slate-200/80 bg-white/90 shadow-[0_24px_64px_rgba(15,23,42,0.08)] lg:col-span-1">
                ...
                <div className="space-y-4 p-5 text-sm leading-7 text-slate-700 sm:p-6">
                  <p>
                    The map centers on the Honeydrop Learning House location
